  ...
  <div className="bg-brand-surface border border-gray-700/50 rounded-xl shadow-lg p-8 md:p-12 max-w-4xl mx-auto animate-fade-in">
    ...
    <div className="space-y-6 text-gray-300">
        ...
        <div>
            ...
            <div className="mt-4 space-y-4">
                <div>
                    <h3 className="text-xl font-semibold text-gray-200">3.1 AI-Powered Content Generation</h3>
                    <p className="mt-2">MenuSparks uses artificial intelligence to generate menu specials, descriptions, and related content based on your restaurant profile and inventory information.</p>
                </div>
                <div>
        ...
        <div>
            ...
            <div className="mt-4 space-y-4">
                ...
                <div>
                    ...
                    <p className="mt-2">Content generated by our AI service for your restaurant becomes your property, but we retain the right to use aggregated, anonymized data for service improvement.</p>
                </div>
                <div>
        ...
        <div>
            ...
            <div className="mt-4 space-y-4">
                ...
                <div>
                    ...
                    <p className="mt-2">The Service provides AI-generated suggestions for menu items, recipes, pricing, and descriptions for informational and inspirational purposes only. You are solely responsible for:</p>
                    <ul className="list-disc list-inside space-y-2 pl-4 mt-2">
                ...
                <div>
                    <h3 className="text-xl font-semibold text-gray-200">8.4 No Warranty for AI Content</h3>
                    <p className="mt-2">We do not warrant that AI-generated content will be error-free, appropriate for your specific needs, or compliant with all applicable regulations. You must review and verify all generated content before use.</p>
                </div>
            </div>
        </div>
