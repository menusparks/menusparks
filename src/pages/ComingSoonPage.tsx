...
const ComingSoonPage: React.FC = () => {
  ...
  return (
    <div className="text-center py-10 md:py-12">
      ...
      <div className="mt-20">
        <div className="max-w-4xl mx-auto bg-brand-surface p-8 rounded-xl border border-gray-700/50 shadow-xl">
          <h2 className="text-3xl font-bold text-center text-white">From a Chef, For Chefs</h2>
          <div className="mt-6 text-center">
             <p className="text-lg text-gray-300 italic leading-relaxed">
              "With over 25 years behind the line, I know the grind. I've faced the inventory puzzles, the pressure for new ideas, and the razor-thin margins. I built MenuSparks to be the tool I wish I'd had—a real culinary partner that understands the realities of the kitchen, not just what looks good on paper."
            </p>
            <p className="mt-4 font-bold text-brand-primary-light">- Michael, Founder & Executive Chef</p>
          </div>
        </div>
      </div>
